    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#vcodeImg").click(function(){
                this.src="get_cpacha?vcodeLen=4&width=160&height=40&t="+new Date().getTime();
            });
        ...
        <form id="form" class="form form-horizontal" method="post">
            ...
            <div class="row cl">
                <div class="formControls col-8 col-offset-3">
                    ...
                    <img title="点击图片切换验证码" id="vcodeImg" src="get_cpacha?vcodeLen=4&width=160&height=40"></div>
            </div>
...
<div class="footer">Copyright &nbsp; HE @ FENGZHENG </div>
